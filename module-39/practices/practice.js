//1 work
    // console.log([] == true);  // expected output is 'false'

// 2 work
    // console.log(true === 'true') // expected output is 'false'
...
/* Write an arrow function that will take 3 parameters (first two parameters will be numbers and the third
    ...
    // let mathCalculator = (num1,num2,calculate)=>{
    //     switch(calculate){
    //         case 'add':
    ...
    //     }
    // }
    // mathCalculator(5,6,'add');
    // mathCalculator(5,6,'multiply');
    // mathCalculator(5,6,'subtract');
